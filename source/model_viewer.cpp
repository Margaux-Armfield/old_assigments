...
color4 material_ambient[8] = {color4( 0.1, 0.1, 0.1, 1.0 ),
    color4( 0.2, 0.2, 0.2, 1.0 ),
    color4( 0.3, 0.3, 0.3, 1.0 ),
    color4( 0.9, 0.1, 0.9, 1.0 ),
    color4( 0.5, 0.5, 0.5, 1.0 ),
    color4( 0.8, 0.5, 0.1, 1.0 ),
    color4( 0.2, 0.3, 0.8, 1.0 ),
    color4( 0.7, 0.9, 0.2, 1.0 )
    };
color4 material_diffuse[8] = {color4( 1.0, 0.8, 0.6, 1.0 ),
color4( 1.0, 0.2, 0.2, 1.0 ),
color4( 0.7, 0.3, 0.3, 1.0 ),
color4( 0.5, 0.2, 0.9, 1.0 ),
color4( 0.8, 0.9, 0.4, 1.0 ),
color4( 1.0, 0.7, 0.9, 1.0 ),
color4( 0.3, 0.5, 0.2, 1.0 ),
color4( 0.9, 0.3, 0.7, 1.0 )
};
color4 material_specular[8] = {color4( 0.8, 0.8, 0.8, 1.0 ),
color4( 1.0, 0.2, 0.2, 1.0 ),
color4( 0.7, 0.3, 0.3, 1.0 ),
color4( 0.5, 0.2, 0.9, 1.0 ),
color4( 0.8, 0.9, 0.4, 1.0 ),
...
float  material_shininess[8] = {10, 2, 17, 4, 30, 8, 18, 1};
...
unsigned int Diffuse_loc;
unsigned int Ambient_loc;
unsigned int Specular_loc;
unsigned int Shininess_loc;
bool wireframe;
int current_draw;
...
int main(void){
  ...
  while (!glfwWindowShouldClose(window)){
    ...
    color4 ambient_product  = light_ambient * material_ambient[current_draw];
    color4 diffuse_product  = light_diffuse * material_diffuse[current_draw];
    color4 specular_product = light_specular * material_specular[current_draw];
    ...
    //glBindBuffer( GL_ARRAY_BUFFER, buffer[current_draw] );
      ...
      glUniform1f(Shininess_loc, material_shininess[current_draw] );
